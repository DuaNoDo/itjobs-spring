...
function() {
    ...
    function o() {
        var t = document.createElement("div");
        t.className = "body-scrollbar-measure", C[0].appendChild(t);
        var e = t.offsetWidth - t.clientWidth;
    ...
    function c() {
        function t() {
            var t = w.scrollTop() >= a;
            t ? (o.addClass("navbar-fixed"), l.show()) : (o.removeClass("navbar-fixed"), l.hide())
        }

        function e(t) {
            if (t.parent().is(".nav")) {
                var e = t.children(".dropdown"),
                    i = t.parents(".navbar:eq(0)"),
                    n = "auto" !== e.css("right"),
                    r = {
                        marginLeft: "",
                        marginRight: "",
        ...
        function n(t) {
            t.hasClass("open") || (e(t), T.to(t.children(".dropdown"), .3, {
                opacity: 1,
                display: "block"
            }), t.addClass("open"), w.trigger("opened-submenu", [t]))
        }
        var r = this,
            o = b(".navbar-top"),
            s = b("[data-nav-mobile]");
        s.length && s.each(function() {
            ...
            e.find(".navbar-mobile-content > ul.nav").append(t)
        });
        var a = o.length ? o.offset().top : 0,
            l = b("<div>").hide();
        o.hasClass("navbar-sticky") && (w.on("scroll resize", t), t(), o.after(l), r.debounceResize(function() {
            l.height(o.innerHeight())
        }));
        var h = void 0;
        o.on("mouseenter", "li.drop-item", function() {
            var t = b(this),
                e = t.siblings(".open").add(t.siblings().find(".open")).add(t.parents(".nav:eq(0)").siblings().find(".open")).add(t.parents(".nav:eq(0)").siblings(".open")).add(t.parents(".nav:eq(0)").parent().siblings().find(".open"));
            clearTimeout(h), i(e), n(t)
        }).on("mouseleave", "li.drop-item", function() {
            var t = b(this);
        ...
        o.filter(".navbar-autohide");
        r.throttleScroll(function(t, e) {
            o.hasClass("navbar-transparent") && o.hasClass("navbar-sticky") && o[(e > 70 ? "add" : "remove") + "Class"]("navbar-solid")
        })
    }
    ...
    function f() {
        var t = this,
            e = b(".navbar-full"),
            i = (b(".navbar-top"), e.find(".nav-social")),
            n = void 0;
        t.fullscreenNavbarIsOpened = function() {
            ...
            if (!n && e.length) {
                n = 1;
                var r = e.find(".nav .drop-item.open > .dropdown:not(.closed) > li > a");
                r.length || (r = e.find(".nav > li > a")), b(".navbar-full-toggle").addClass("active"), T.set(r, {
                    opacity: 0,
                    force3D: !0
                }), T.set(i, {
                    opacity: 0,
                    ...
                    opacity: 1,
                    delay: .4
                }), e.addClass("open"), t.bodyOverflow(1), w.trigger("open-full-navbar", [e])
            }
        }, t.closeFullscreenNavbar = function(i) {
            n && e.length && (n = 0, b(".navbar-full-toggle").removeClass("active"), T.to(e, .5, {
                opacity: 0,
                force3D: !0,
                display: "none",
                onComplete: function() {
            ...
            }), e.removeClass("open"), w.trigger("close-full-navbar", [e]))
        }, E.on("click", ".navbar-full-toggle", function(e) {
    ...
    function d() {
        function t(t) {
            var e = t.parents(".navbar:eq(0)"),
                n = e.find(".nav"),
                r = e.find(".drop-item.open > .dropdown:not(.closed)"),
                o = r.parents(".dropdown.closed:eq(0)"),
                s = t.parents(".nano:eq(0)"),
                a = s.children(".nano-content"),
                l = t.parents(".nav-row:eq(0)"),
                h = l.siblings(".nav-row");
            if (r.length) {
                var u = r.innerHeight();
                l.hasClass("nav-row-center") && ! function() {
                    r.css({
                        top: 0
                    });
                    var t = s.innerHeight(),
        ...
        var i = this,
            n = b(".navbar-full");
        n.find(".dropdown").prepend('<li class="bropdown-back"><a href="#">Back</a></li>'), n.on("click", ".drop-item > a", function(i) {
    ...
    function p() {
        ...
        var r = this;
        E.on("click", ".navbar a, a.header-title-scroll-down", function(e) {
            var i = this.hash,
                n = this.baseURI === window.location.href;
            if (i && n) {
                var o = b(i),
                    s = i.replace(/^#/, "");
                (o.length || "top" === s || "bottom" === s) && (t(), o.length && !b(this).hasClass("header-title-scroll-down") && (o.attr("id", ""), document.location.hash = s, o.attr("id", s)), r.scrollTo(o.length ? o : s), e.preventDefault())
            }
        });
        var o = b('.navbar .nav > li > a[href*="#"]'),
            s = [];
        o.each(function() {
    ...
    function v() {
        ...
        if ("undefined" != typeof window.Flickity) {
            var e = b(".carousel");
            e.length && (e.children(".carousel-inner").each(function() {
                b(this).flickity({
            ...
            }), t(e.children(".carousel-inner"))), b(".carousel-2 > .carousel-inner").each(function() {
                b(this).flickity({
                    pageDots: "true" === b(this).parent().attr("data-dots") || !1,
                    autoPlay: parseFloat(b(this).parent().attr("data-autoplay")) || !1,
                    prevNextButtons: !1,
    ...
    function y() {
        if ("undefined" != typeof window.Isotope) {
            ...
            b(".isotope").each(function() {
                ...
                var n = [];
                n = e.parent().hasClass("portfolio-list") ? e.parent().prev(".isotope-filter") : e.prev(".isotope-filter"), n.length && n.on("click", "[data-filter]", function(t) {
                    t.preventDefault();
            ...
            }), C.on("click", '[href="#toggle-filter"]:not(.busy)', function(t) {
                var e = b(this).parent(".pagination"),
                    n = e.next(".isotope-filter"),
                    r = n.hasClass("isotope-filter-active");
                if (e.length && n.length)
                    if (t.preventDefault(), t.stopPropagation(), e.addClass("busy"), r) T.staggerTo(n.children(), .2, {
                        ...
                        T.to(n, .4, {
                            ...
                            display: "none",
                            onComplete: function() {
                                e.removeClass("isotope-filter-active"), n.removeClass("isotope-filter-active"), e.removeClass("busy"), i()
                            }
                        })
                    });
                    else {
                        ...
                        n.css("height", 0), T.set(n.children(), {
                            ...
                            onComplete: function() {
                                T.staggerTo(n.children(), .2, {
                                    ...
                                    e.addClass("isotope-filter-active"), n.addClass("isotope-filter-active"), e.removeClass("busy"), i()
                                })
                            }
                        })
                    }
...
/*$(window).scroll(function() {
	  ...
	  if($(this).scrollTop() > 70|| $(this).scrollTop() == 0) $el.fadeIn();
...
function like(){
    ...
    frm.action = 'IT_addMyLikeAdvertisement.jsp';
    frm.method ="post";
    frm.submit();
}
function dele(){
	var frm =document.getElementById('listForm');
	frm.action = 'IT_delMyLikeAdvertisement.jsp';
    frm.method ="post";
    frm.submit();
}
function purchase(){
	var frm =document.getElementById('listForm');
    frm.action = 'IT_buyMyLikeAdvertisement.jsp';
    frm.method ="post";
    frm.submit();
}
